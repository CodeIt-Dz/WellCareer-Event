...
SECRET_KEY = 'django-insecure-z9zr#!h2k7gfps!-o#z-**qrh+qv6jgz1we9y$sq8sya+on705'
...
ELASTICSEARCH_DSL = {
    'default': {
        'hosts': '127.0.0.1:9200'  # Change this if your Elasticsearch server is hosted elsewhere
    },
}
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'rest_framework_simplejwt.authentication.JWTAuthentication',  # If using JWT Authentication
    )
}
...
EMAIL_HOST_PASSWORD = 'tvfqoqclrsapgncf'

DEFAULT_FROM_EMAIL = 'noreply@wellpharma.com'
